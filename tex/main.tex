...
% \colorbox{Plum}{TODO: correct?}
In this work, I primarily focus on scalar perturbations, 
% \colorbox{Plum}{TODO: correct? velocity}
...
% is no longer equal to $\Theta_2$ 
% that appears in these equations, as well as in those presented in the two previous sections, is no longer simply the same as $\Theta_2$. \colorbox{Plum}{word differently}. Instead, it now includes contributions from the polarization monopole and quadrupole: 
\begin{equation} 
